    ...
    <div class="row">
        <div class="container">
            <form method="post" id="f1" name="f1">
                ...
                <div class="row justify-content-center table-responsive text-center my-5">
                    <table class="table table-bordered col-8 m-x-auto" cellspacing=0>
                        <thead>
                        <tr>
                            <td class="HeaderOfTable text-center">
                                گزارش خطا
                            </td>
                        </tr>
                        </thead>
                        ...
                        <tr>
                            <td class="p-3" style="line-height: 1.7;">
                                - در صورتی که هنگام کار با پورتال خود به مشکلی برخورد کرده‌اید و فکر می‌کنید مربوط
                                به
                                برنامه
                                می‌باشد، برای گزارش کردن این خطا به مرکز کامپیوتر می‌توانید این فرم را تکمیل و ارسال
                                نمایید.
                                <br>
                                - همراه با توضیحات شما اطلاعات مربوط به کاربر و مشخصات اتصال شما از جمله نوع مرورگر
                                و
                                سیستم‌عامل
                                مورد استفاده نیز ارسال خواهد شد. تا با بررسی آنها خطای مربوطه رفع شود.
                                <br>
                                - لطفاً توضیحات مربوط به خطا را تا حد امکان کامل وارد نمایید تا سریع‌تر بتوان آن را
                                رفع
                                نمود.
                                <br>
                                - از طریق همین صفحه می‌توانید لیست گزارشات خطای ارسالی خود و وضعیت آنها را مشاهده
                                نمایید.
                                <br>
                            ...
                            <td>
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <label for="description col-4">
                                            توضیحات:
                                        </label>
                                        <textarea rows="5" cols="80" class="form-control col-6" id=description
                                                  name=description required></textarea>
                                    </div>
                                </div>

                                <div class="col-12">
                                    <label for="CallBackNumber">
                                        شماره تماس:
                                    </label>
                                    <input
                                            type=text
                                            ...
                                            value=''
                                            placeholder="در صورت نیاز با شما تماس گرفته خواهد شد">
                                </div>
                        ...
                        <tr>
                            <td align=center class=FooterOfTable>
                                <input type=button
                                       onclick='javascript: if(document.getElementById("description").value!="") document.getElementById("f1").submit(); else alert("توضیحات را وارد نمایید");'
                                       class="btn btn-primary"
                                       value='ارسال'>
                                <input type=button value='بستن' class="btn btn-danger"
