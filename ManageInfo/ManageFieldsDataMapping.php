...
<form method=post id=f1 name=f1>
    <input class="form-control" type=hidden name=WizardReportID id=WizardReportID value='<?php echo $_REQUEST["WizardReportID"]; ?>'>
    <table class="form-group" width=95% align=center border=1 cellspacing=0 cellpadding=3>
        <tr>
            <td>
                <table class="w-100" border=0>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <select class="form-control" name=DBName id=DBName dir=ltr onchange='javascript: document.f1.submit();'>
                                    <option value=''>-
                                        <?php
...
<?php  if(isset($_REQUEST["Save"]) && $FieldName!="") { ?>
    ...
    <form method=post id=f3 name=f3>
        <input class="form-control" type=hidden name=FinalSave id=FinalSave value=1>
        <input class="form-control" type=hidden name=Save id=Save value=1>
        <input class="form-control"type=hidden name=DBName id=DBName value='<?php echo $DBName; ?>'>
        <input class="form-control" type=hidden name=TableName id=TableName value='<?php echo $TableName; ?>'>
        <input class="form-control" type=hidden name=FieldName id=FieldName value='<?php echo $FieldName; ?>'>
        <table width=95% align=center>
            <tr>
                <td>
                    <?php echo REAL_VAL ?>
                    <input class="form-control" type=text name=ActualValue id=ActualValue size=20>
                    <?php echo M_VAL_EQ ?>
                    <input class="form-control" type=text name=ShowValue id=ShowValue size=60>
